...
import com.example.tagger.R.color;
import com.example.tagger.R.string;
  ...
  protected void onDraw(Canvas canvas) {
    ...
    for (int i = 0; i < 24; i++) {
      ...
      if(dir==i){
          ...
          canvas.drawLine(px, arrowZ, px-5, 3*textHeight,
                          markerPaint);
          canvas.drawLine(px, arrowZ, px+5, 3*textHeight,
                          markerPaint);
